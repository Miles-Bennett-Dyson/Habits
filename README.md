...
Чтобы воспользоватся сервисом, перейдите по адресу в браузере: http://158.160.25.183
---
...
Если вы хотите запустить сервер локально, достаточно выполнить команду: docker compose up -d --build   

Образ соберется автоматически и запустятся необходимые контейнеры, после этого перейдите в браузере по адресу: http://127.0.0.1:8000
...
http://158.160.25.183/swagger/  для Swagger UI  
http://158.160.25.183/redoc/ для Redoc.    
